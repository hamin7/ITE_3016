...
<%
 int uniform_id= Integer.parseInt( imageUp.getParameter("uniform_id"));
 ...
 String uniform_content = imageUp.getParameter("uniform_content");
...
uniformProcess.updateUniform(uniform, uniform_id); 
